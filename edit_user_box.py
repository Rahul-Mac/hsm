...
class edit_user_box(QtWidgets.QDialog):
    ...
    def generate(self):
        global_variable.mycursor.execute("SELECT IsActive, UserType, EmployeeCode, UserName from user where UserId = '"+global_variable.UID+"'")
    ...
    def update(self):
        ...
        try:
            if  i == "" or u == "" or e == "" or t == "" or t == "-- Select --" or a == "":
                ...
                global_variable.mycursor.execute("SELECT EmployeeCode FROM user WHERE UserId = '"+i+"'")
